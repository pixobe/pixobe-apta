...
<div class="wp-block-group has-contrast-background-color has-background" style="margin-top:0;margin-bottom:0"><!-- wp:spacer {"height":"0px","style":{"layout":{"selfStretch":"fixed","flexSize":"50px"}}} -->
    ...
    <!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10"}},"elements":{"link":{"color":{"text":"var:preset|color|base-2"}}}},"textColor":"base-2","fontSize":"x-large"} -->
    ...
    <!-- wp:group {"metadata":{"categories":["buttons"],"patternName":"core/block/299","name":"Button Group"},"style":{"spacing":{"blockGap":"var:preset|spacing|10","margin":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
    ...
    <figure class="wp-block-image size-full"><img src="" alt="Greeting card and Memes Maker Plugin" class="wp-image-226" /></figure>
    <!-- /wp:image -->
</div>
<!-- /wp:group -->