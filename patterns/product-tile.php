...
<!-- wp:group {"metadata":{"categories":["products","cards"],"patternName":"apta/product-tile","name":"Product Tile"},"className":"has-background has-base-background-color is-style-rounded wp-product-tile","style":{"spacing":{"padding":{"right":"var:preset|spacing|10","left":"var:preset|spacing|10","top":"var:preset|spacing|10","bottom":"var:preset|spacing|10"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-background has-base-background-color alignwide  wp-product-tile" style="padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10)">
    ...
    <div class="wp-block-group"><!-- wp:image {"width":"48px","sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full is-resized"><img src="/wp-content/uploads/2024/09/cropped-Logo-Dark.png" alt="" style="width:48px" /></figure>
        <!-- /wp:image -->
