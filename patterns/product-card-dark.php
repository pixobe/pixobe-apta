 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["products","cards"],"patternName":"apta/product-card-dark","name":"Product Card"},"className":"has-background has-contrast-background-color has-text-color has-base-color is-product-card-dark","style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
<div class="wp-block-group has-background has-contrast-background-color has-text-color has-base-color is-product-card-dark"><!-- wp:spacer {"height":"50px"} -->
